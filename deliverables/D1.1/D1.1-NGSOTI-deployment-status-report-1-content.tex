...
\item \textbf{Lookup Table Aggregations}: Tenzir's lookup tables are a building
	...
	in November
	2024.\footnote{https://docs.google.com/presentation/d/1SnWQMBN7HQ4ASckUgy_kfQyWzHSnrN9zl-m4ptMVolQ/present}
...
\item \textbf{String Function Processing}: In order to support flexible
	...
	transformation.\footnote{https://docs.tenzir.com/tql2/functions#string}
