...
\begin{itemize}
	...
	{\bf{headscale}}{\footnote{https://headscale.net/stable/}} that is an open
...
\begin{itemize}
	\item overall architecture https://github.com/ngsoti/internal-notes/blob/main/WP2/README.md
	\item how to create containers https://github.com/ngsoti/internal-notes/blob/main/WP2/containers.md
	\item how to manage headscale https://github.com/ngsoti/internal-notes/blob/main/WP2/headscale.md
	\item how to onboard new admin user https://github.com/ngsoti/internal-notes/blob/main/WP2/onboarding.md
	\item how to manage the tailnet router https://github.com/ngsoti/internal-notes/blob/main/WP2/tailnet-router.md
\end{itemize}
