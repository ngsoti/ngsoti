...
% Hyperref setup
\hypersetup{
    pdftitle={NGSOTI data key findings report \#1},
...
\fancyfoot[C]{Deliverable D2.2 NGSOTI data key findings report \#1 - page \thepage/\pageref{LastPage}}
